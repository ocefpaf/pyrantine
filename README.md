...
| Status                                                                                      |
| ------------------------------------------------------------------------------------------- |
| ![Linux](https://github.com/ocefpaf/pyrantine/actions/workflows/linux-tests.yml/badge.svg)  |
| ![macOS](https://github.com/ocefpaf/pyrantine/actions/workflows/osx-tests.yml/badge.svg)    |
| ![Win](https://github.com/ocefpaf/pyrantine/actions/workflows/win-tests.yml/badge.svg)      |

| Binder |
| ------ |
| [![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/ocefpaf/pyrantine/master) |
